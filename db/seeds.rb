...
password: 'troqueestasenha', cliente: b.first)
...
email: 'juliocesar@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Paulo Roberto ', status: 1, tipo: 2, telefone: '(92)984050677',
email: 'pauloroberto@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Pietro', status: 1, tipo: 2, telefone: '(92)981020020',
email: 'pietro@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Marcelo', status: 1, tipo: 2, telefone: '(92)981125490',
 email: 'marcelo@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Borges Júnior', status: 1, tipo: 2, telefone: '(61)993099075',
 email: 'borgesjunior@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Adilson', status: 1, tipo: 2, telefone: '(92)982120031',
email: 'adilson@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Tsuruda', status: 1, tipo: 2, telefone: '(92)994488625',
 email: 'tsuruda@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Marco', status: 1, tipo: 2, telefone: '(32)991325858',
 email: 'marco@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Luiz Carlos', status: 1, tipo: 2, telefone: '(32)984540608',
 email: 'luizcarlos@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Fidélis', status: 1, tipo: 2, telefone: '(92)992691623',
 email: 'fidelis@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Xavier', status: 1, tipo: 2, telefone: '(92)981584709',
 email: 'xavier@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Tayar', status: 1, tipo: 2, telefone: '(92)92999300',
email: 'tayar@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Wilson Alves', status: 1, tipo: 2, telefone: '(92)984170633',
 email: 'wilsonalves@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'André Mendes', status: 1, tipo: 2, telefone: '(11)982086835',
 email: 'andremendes@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)
...
Usuario.create!(nome: 'Trojaike', status: 1, tipo: 2, telefone: '(92)984091572',
 email: 'trojaike@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Pablo', status: 1, tipo: 2, telefone: '(92)993447172',
 email: 'pablo@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Leandro Farias', status: 1, tipo: 2, telefone: '(92)92982812121',
 email: 'leandrofarias@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Maurício', status: 1, tipo: 2, telefone: '(92)995001496',
 email: 'mauricio@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'De Felice', status: 1, tipo: 2, telefone: '(21)92446776',
 email: 'defelice@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Ingrid Silva', status: 1, tipo: 2, telefone: '(92)99253-0315',
 email: 'ingridsilva@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Cunha', status: 1, tipo: 2, telefone: '(92)984292922',
 email: 'cunha@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Lendel', status: 1, tipo: 2, telefone: '(92)981437456',
 email: 'lendel@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Isabella chapira', status: 1, tipo: 2, telefone: '(92)99253-0315',
 email: 'isabellachapira@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Lucas Machado', status: 1, tipo: 2, telefone: '(92)992448445',
 email: 'lucasmachado@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Hermany', status: 1, tipo: 2, telefone: '(92)992381830',
 email: 'hermany@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Danilo', status: 1, tipo: 2, telefone: '(92)981765246',
 email: 'danilo@4cta.eb.mil.br',password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Denys', status: 1, tipo: 2, telefone: '(92)91174322',
 email: 'denys@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Edilton Lopes', status: 1, tipo: 2, telefone: '(92)',
 email: 'ediltonlopes@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Henrique Alves', status: 1, tipo: 2, telefone: '(21)992630391',
 email: 'henriquealves@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Renovato', status: 1, tipo: 2, telefone: '(92)991341590',
 email: 'renovato@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Marcos Rocha', status: 1, tipo: 2, telefone: '(92)991262978',
 email: 'marcosrocha@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Gonzales ', status: 1, tipo: 2, telefone: '(92)991420521',
 email: 'gonzales@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Loel', status: 1, tipo: 2, telefone: '(92)993947822',
 email: 'loel@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: ' Rolim', status: 1, tipo: 2, telefone: '(92)994234935',
 email: 'rolim@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Keller', status: 0, tipo: 2, telefone: '(92)981126434',
 email: 'keller@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Oliveira', status: 1, tipo: 2, telefone: '(92)991281393',
 email: 'aspoliveira@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Hanada', status: 1, tipo: 2, telefone: '(92)984193332',
 email: 'hanada@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)
...
Usuario.create!(nome: 'Valter', status: 1, tipo: 2, telefone: '(92)981471154',
 email: 'valter@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Tadeu', status: 1, tipo: 2, telefone: '(92)999696356',
 email: 'tadeu@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Lucena', status: 1, tipo: 2, telefone: '(61)981612197',
 email: 'lucena@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Lisboa', status: 1, tipo: 2, telefone: '',
 email: 'lisboa@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Edirregis', status: 1, tipo: 2, telefone: '(22)997612596',
 email: 'edirregis@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Cruz', status: 1, tipo: 2, telefone: '(92)991576394',
 email: 'cruz@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Sergio Carlos', status: 1, tipo: 2, telefone: '(92)992687631',
 email: 'sergiocarlos@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Figueiredo', status: 1, tipo: 2, telefone: '(92)991295713',
 email: 'figueiredo@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Alexandre', status: 1, tipo: 2, telefone: '(92)994153701',
email: 'alexandre@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Teixeira', status: 1, tipo: 2, telefone: '(92)996098122',
 email: 'teixeira@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Fernando', status: 1, tipo: 2, telefone: '(71)993412213',
 email: 'fernando@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Jurandir', status: 1, tipo: 2, telefone: '(92)981143666',
 email: 'jurandir@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'João', status: 1, tipo: 2, telefone: '(32)999009172',
 email: 'joao@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Wagner', status: 1, tipo: 2, telefone: '(92)993845747',
 email: 'wagner@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'André Luiz', status: 1, tipo: 2, telefone: '(21)995801250',
 email: 'andreluiz@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Ângelo', status: 1, tipo: 2, telefone: '(31)991134818',
 email: 'angelo@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Nascimento', status: 1, tipo: 2, telefone: '(92)993013689',
 email: 'nascimento@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Leite', status: 1, tipo: 2, telefone: '(81)996050947',
 email: 'leite@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Anderson', status: 1, tipo: 2, telefone: '(92)991388959',
 email: 'anderson@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

#Usuario.create!(nome: 'Nunes', status: 1, tipo: 2, telefone: '(92)984374240',
# email: 'nunes@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Fredson', status: 1, tipo: 2, telefone: '(92)993269708',
 email: 'fredson@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Pedro', status: 1, tipo: 2, telefone: '(92)992700042',
 email: 'pedro@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Chervinski', status: 1, tipo: 2, telefone: '(92)992696050',
 email: 'chervinski@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Gama', status: 1, tipo: 2, telefone: '(92)988050203',
 email: 'gama@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Da Costa', status: 1, tipo: 2, telefone: '(92)995144199',
 email: 'dacosta@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Emerson', status: 1, tipo: 2, telefone: '(92)999981944',
 email: 'emerson@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Luiz Castro', status: 1, tipo: 2, telefone: '(92)984703079',
 email: 'luizcastro@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Alberto', status: 1, tipo: 2, telefone: '(92)993837633',
 email: 'alberto@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Sergio', status: 1, tipo: 2, telefone: '(92)988389272',
 email: 'sergio@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'J Augusto ', status: 1, tipo: 2, telefone: '(92)994249447',
 email: 'jaugusto@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Raimar', status: 1, tipo: 2, telefone: '(92)999692395',
 email: 'raimar@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Cicero', status: 1, tipo: 2, telefone: '(92)994839153',
 email: 'cicero@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Lopes', status: 1, tipo: 2, telefone: '(92)999624784',
 email: 'lopes@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Cabral', status: 1, tipo: 2, telefone: '(92)994575024',
 email: 'cabral@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Scher', status: 1, tipo: 2, telefone: '(81)996406211',
 email: 'scher@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Levi', status: 1, tipo: 2, telefone: '(92)981087688',
 email: 'levi@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Rômulo', status: 1, tipo: 2, telefone: '(21)964196890',
 email: 'romulo@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Paulo Júnior', status: 1, tipo: 2, telefone: '(92)992214690',
 email: 'paulojunior@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Rodrigues', status: 1, tipo: 2, telefone: '(92)993437640',
 email: 'rodrigues@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Matos', status: 1, tipo: 2, telefone: '(92)991415450',
 email: 'matos@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Magalhães', status: 1, tipo: 2, telefone: '(92)981288726',
 email: 'magalhaes@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Andrio', status: 1, tipo: 2, telefone: '(92)992659797',
 email: 'andrio@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

#Usuario.create!(nome: 'Borges', status: 1, tipo: 2, telefone: '(92)991143425',
# email: 'borges@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'André Rocha', status: 1, tipo: 2, telefone: '(92)996158370',
 email: 'andrerocha@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Fontenelle', status: 1, tipo: 2, telefone: '(92)984134535',
 email: 'fontenelle@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Santana', status: 1, tipo: 2, telefone: '(92)991710186',
 email: 'santana@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Gonçalves', status: 1, tipo: 2, telefone: '(92)993251644',
 email: 'gonçalves@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Manoel', status: 1, tipo: 2, telefone: '(92)990024084',
 email: 'manoel@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'cavalcante', status: 1, tipo: 2, telefone: '(92)992284018',
 email: 'cavalcante@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

Usuario.create!(nome: 'Costa', status: 1, tipo: 2, telefone: '(92)994511407',
 email: 'costa@4cta.eb.mil.br', password: 'troqueestasenha', cliente: b.first)

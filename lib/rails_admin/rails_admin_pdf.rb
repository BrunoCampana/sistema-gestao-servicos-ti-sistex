        ...
        register_instance_option :controller do
          Proc.new do
            ...
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              pdf.text "Relatório do 4º CTA", :size => 32, :style => :bold, :align => :center
              pdf.move_down 80

              pdf.text "Dados do cliente", :size => 14, :align => :justify, :inline_format => true, :style => :bold
              pdf.move_down 14

              if @object.name
                pdf.text "Nome: #{@object.nome}", :size => 12, :align => :justify, :inline_format => true
                pdf.move_down 8
              end

              if @object.endereco
                pdf.text "Endereço: #{@object.endereco}", :size => 12, :align => :justify, :inline_format => true
                pdf.move_down 8
              end

              if @object.subordinacao
                pdf.text "Subordinação: #{@object.subordinacao}", :size => 12, :align => :justify, :inline_format => true
                pdf.move_down 8
              end

              if @object.uasg
                pdf.text "UASG: #{@object.uasg}", :size => 12, :align => :justify, :inline_format => true
                pdf.move_down 8
              end

              if @object.missao_fim_om
                pdf.text "Missão fim da OM: #{@object.missao_fim_om}", :size => 12, :align => :justify, :inline_format => true
                pdf.move_down 8
              end
=begin
              pdf.move_down 20
